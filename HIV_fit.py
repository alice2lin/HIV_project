# -*- coding: utf-8 -*-
"""
Created on Fri Apr  7 10:46:38 2023
...
# We opened the hivseries.csv file and converted the data to float
hiv_data_location = os.path.abspath("C:\\Users\\snowb\\anaconda3\\CHEM 5630\\HIV_project_class\\HIVseries.csv")
hiv_data_string = np.genfromtxt(fname=hiv_data_location,delimiter=',',dtype='unicode')
hiv_data = hiv_data_string.astype(float)
...
guess_parameters = [10000,60000,0.1,10]
...
# Plot the fitted curve on top of data points
